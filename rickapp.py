...
if menu_nav == 'Home Page':
    ...
    st.write("My professional interests lie at the intersection of real-world machine learning applications and data visualization. "
     ...
     "My current goal is to gain the opportunity to gauage a better understanding of human-computer interactions and apply my data-driven skills in the workforce.")
